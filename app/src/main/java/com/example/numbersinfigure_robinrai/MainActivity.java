package com.example.numbersinfigure_robinrai;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initiate(){
        ...
        txtnumber=findViewById(R.id.TxtNumberInput);
        txtresult=findViewById(R.id.TxtNumberOutput);
        btnConvert=findViewById(R.id.BtnNumberConvert);
